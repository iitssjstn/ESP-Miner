...
typedef enum {
    ...
    NVS_CONFIG_AUTOTUNE_MAX_VOLTAGE,
    NVS_CONFIG_AUTOTUNE_MAX_FREQUENCY,
    NVS_CONFIG_AUTOTUNE_MAX_TEMP,
    NVS_CONFIG_AUTOTUNE_VOLTAGE_STEP,
    NVS_CONFIG_AUTOTUNE_FREQUENCY_STEP,
