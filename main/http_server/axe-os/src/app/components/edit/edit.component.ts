...
export class EditComponent implements OnInit, OnDestroy, OnChanges {
    ...
    .subscribe(({ info, asic }) => {
      ...
      if (info.overclockEnabled) {
        ...
        this.form = this.fb.group({
          ...
          autotuneEnabled: [info.autotuneEnabled == 1],
          autotunePerformanceMode: [info.autotunePerformanceMode == 1],
          autotuneMaxTemp: [info.autotuneMaxTemp, [Validators.min(0), Validators.max(100)]],
          autotuneVoltageStep: [info.autotuneVoltageStep, [Validators.min(0)]],
          autotuneFrequencyStep: [info.autotuneFrequencyStep, [Validators.min(0)]],
          autotuneMaxVoltage: [info.autotuneMaxVoltage, [Validators.min(0)]],
          autotuneMaxFrequency: [info.autotuneMaxFrequency, [Validators.min(0)]],
  ...
  get noRestartFields(): string[] {
    return [
      ...
      'frequency',
      'autotuneEnabled',
      'autotunePerformanceMode',
      'autotuneMaxTemp',
      'autotuneVoltageStep',
      'autotuneFrequencyStep',
      'autotuneMaxVoltage',
      'autotuneMaxFrequency',
      'autofanspeed',
      'minFanSpeed',
      'manualFanSpeed',
      'temptarget',
